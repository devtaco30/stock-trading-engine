 ...
 */
public final class NoOpAccountResultListener implements AccountResultListener {

    public static final NoOpAccountResultListener INSTANCE = new NoOpAccountResultListener();
