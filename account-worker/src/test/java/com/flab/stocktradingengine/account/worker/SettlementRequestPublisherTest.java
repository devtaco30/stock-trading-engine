 ...
 * 검증한다. dueDate는 T+2(영업일 미고려)이므로 시각을 고정한 Clock으로 계산한다.
 */
class SettlementRequestPublisherTest {
    ...
    @Test
    void 미수금이_생기면_accountId_키로_settlementRef_dueDate를_실어_발행한다() {
        ...
        SettlementRequestEvent expected =
            new SettlementRequestEvent(9001L, 1L, new BigDecimal("60000"), LocalDate.of(2026, 9, 10));
