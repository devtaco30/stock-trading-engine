...
# C7 부하 테스트 하네스 — v1(api·order-engine·matching-engine·settlement-engine)을 로컬
# 백그라운드로 기동한다. 기존 application-loadtest.yml 4개(2026-09-04 구축)를 그대로 재사용.
cd "$(dirname "$0")/.."
